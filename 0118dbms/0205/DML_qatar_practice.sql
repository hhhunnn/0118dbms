...
-- 경기장에 데이터 삽입
-- 		경기일정		 , country1, country2, stadium
-- 1. 2024-02-07 00:00:00, 요르단, 대한민국, 아흐메드 빈 알리 
INSERT INTO game(schedule, country1, country2, stadium) VALUES ('2024-02-07 00:00:00', '요르단', '대한민국','아흐메드 빈 알리');
SELECT * FROM game;
