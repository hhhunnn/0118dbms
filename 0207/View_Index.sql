...
SELECT E.employee_number AS employee_number, E.name AS employee_name, D.code AS department_code, 
		D.name AS department_name, D.tel_number AS department_tel_number
FROM employee AS E 
...
-- VIEW는 물리적으로 데이터가 복사되는 것이 아니고 논리적으로 결과를 불러오는 것이기 때문에
-- VIEW 자체로 INSERT, UPDATE, DELETE가 불가능
INSERT INTO employee_view VALUES (10, '김길동', 'MM', '물류부', '010-1111-1114'); -- ERROR
...
SELECT * FROM department WHERE tel_number = '010-1111-1111' AND name = '인사부'; -- 안빠름, 순서가 중요!!
